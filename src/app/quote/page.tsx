          ...
          >
            <form onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6 mb-12">
                ...
                <div>
                  <label className={labelClass}>School / Company / Organisation Name <span className="text-red-500">*</span></label>
                  <input type="text" placeholder="Enter organisation name" className={inputClass} />
                </div>
                <div>
                  ...
                  <div className="flex">
                    ...
                    <input type="tel" placeholder="Enter mobile number" className="w-full bg-gray-50/50 border border-gray-200 rounded-r-lg px-4 py-3.5 text-[14px] text-gray-800 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#3FAE49]/20 focus:border-[#3FAE49] transition-all font-medium" />
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex">
                    ...
                    <input type="tel" placeholder="Enter WhatsApp number" className="w-full bg-gray-50/50 border border-gray-200 rounded-r-lg px-4 py-3.5 text-[14px] text-gray-800 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#3FAE49]/20 focus:border-[#3FAE49] transition-all font-medium" />
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="text" placeholder="Enter your city / district" className={inputClass} />
                </div>
                <div>
                  <label className={labelClass}>Preferred Contact <span className="text-red-500">*</span></label>
                  <div className="flex items-center gap-6 mt-4">
                    <label className="flex items-center gap-2 cursor-pointer group">
                      <input type="radio" name="contact" defaultChecked className="w-4 h-4 accent-[#3FAE49] cursor-pointer" />
                      <span className="text-[13px] font-bold text-gray-700 group-hover:text-[#3FAE49] transition-colors">WhatsApp</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer group">
                      <input type="radio" name="contact" className="w-4 h-4 accent-[#3FAE49] cursor-pointer" />
                ...
                {products.map(p => {
                  ...
                  return (
                    <div
                      ...
                      className={`border rounded-xl p-5 flex flex-col items-center justify-center text-center gap-3 cursor-pointer transition-all duration-300 relative overflow-hidden ${isSelected ? 'border-[#3FAE49] bg-[#EAF6EA] shadow-[0_4px_12px_rgba(63,174,73,0.1)]' : 'border-gray-200 hover:border-[#3FAE49]/40 bg-white'}`}
                    >
                      {isSelected && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div>
                  <label className={labelClass}>Approximate Quantity <span className="text-red-500">*</span></label>
                  <input type="number" placeholder="Enter quantity" className={inputClass} />
                </div>
                <div>
                ...
                <div>
                  <label className={labelClass}>Required Delivery Date <span className="text-red-500">*</span></label>
                ...
                <div className="flex flex-wrap gap-8 mt-4">
                  {['Kids', 'Students', 'Adults', 'Mixed Sizes'].map(size => (
                    <label key={size} className="flex items-center gap-3 cursor-pointer group">
                      <input type="checkbox" className="w-5 h-5 accent-[#3FAE49] cursor-pointer border-gray-300 rounded" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-5 gap-x-6 mb-12 bg-gray-50/50 p-6 rounded-xl border border-gray-100">
                {['Logo Embroidery', 'Screen Printing', 'Sublimation Printing', 'Name Printing', 'Number Printing', 'Custom Design', 'Not Sure — Need Guidance'].map(opt => (
                  <label key={opt} className="flex items-center gap-3 cursor-pointer group">
                    <input type="checkbox" className="w-5 h-5 accent-[#3FAE49] cursor-pointer rounded" />
                ...
                <div className="flex flex-wrap gap-8 mt-4">
                  {['Yes', 'No', 'Need Design Support'].map(opt => (
                    <label key={opt} className="flex items-center gap-2 cursor-pointer group">
                      <input type="radio" name="hasDesign" className="w-5 h-5 accent-[#3FAE49] cursor-pointer" />
                      <span className="text-[14px] font-bold text-gray-700 group-hover:text-[#3FAE49] transition-colors">{opt}</span>
                    </label>
                  ))}
                </div>
              ...
              <div className="mb-12">
                <label className="flex items-start gap-4 cursor-pointer bg-gray-50/80 p-5 rounded-xl border border-gray-100 hover:border-[#3FAE49]/30 transition-all">
                  <input type="checkbox" defaultChecked className="w-5 h-5 mt-0.5 accent-[#3FAE49] cursor-pointer" />
              ...
              <div className="pt-6 border-t border-gray-100">
                <button type="button" className="w-full bg-[#3FAE49] hover:bg-[#2A3F2D] text-white py-5 rounded-xl font-black text-[16px] uppercase tracking-[0.15em] shadow-[0_8px_20px_rgba(63,174,73,0.25)] hover:shadow-[0_8px_25px_rgba(42,63,45,0.3)] transition-all duration-300 flex items-center justify-center gap-3 group">
                  GET MY QUOTE
